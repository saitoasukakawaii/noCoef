function qnew=init(t, dt, method)
   ...
   T=1.0;
        ...
        b8 =5.744;
        b9 =2.425;
        qnew = a0+a1*sin(2*pi*1*t/T)+b1*cos(2*pi*1*t/T)+a2*sin(2*pi*2*t/T)    ...
                    +b2*cos(2*pi*2*t/T)+a3*sin(2*pi*3*t/T)+b3*cos(2*pi*3*t/T)  ...
                    +a4*sin(2*pi*4*t/T)+b4*cos(2*pi*4*t/T)+a5*sin(2*pi*5*t/T)  ...
                    +b5*cos(2*pi*5*t/T)+a6*sin(2*pi*6*t/T)+b6*cos(2*pi*6*t/T)  ...
                    +a7*sin(2*pi*7*t/T)+b7*cos(2*pi*7*t/T)+a8*sin(2*pi*8*t/T)  ...
                    +b8*cos(2*pi*8*t/T)+a9*sin(2*pi*9*t/T)+b9*cos(2*pi*9*t/T)  ...
                    +a10*sin(2*pi*10*t/T)+b10*cos(2*pi*10*t/T)+a11*sin(2*pi*11*t/T)    ...
                    +b11*cos(2*pi*11*t/T)+a12*sin(2*pi*12*t/T)+b12*cos(2*pi*12*t/T)    ...
                    +a13*sin(2*pi*13*t/T)+b13*cos(2*pi*13*t/T)+a14*sin(2*pi*14*t/T)    ...
                    +b14*cos(2*pi*14*t/T)+a15*sin(2*pi*15*t/T)+b15*cos(2*pi*15*t/T)    ...
                    +a16*sin(2*pi*16*t/T)+b16*cos(2*pi*16*t/T)+a17*sin(2*pi*17*t/T)    ...
                    +b17*cos(2*pi*17*t/T)+a18*sin(2*pi*18*t/T)+b18*cos(2*pi*18*t/T)    ...
                    +a19*sin(2*pi*19*t/T)+b19*cos(2*pi*19*t/T)+a20*sin(2*pi*20*t/T)    ...
                    +b20*cos(2*pi*20*t/T)+a21*sin(2*pi*21*t/T)+b21*cos(2*pi*21*t/T)    ...
                    +a22*sin(2*pi*22*t/T)+b22*cos(2*pi*22*t/T)+a23*sin(2*pi*23*t/T)    ...
                    +b23*cos(2*pi*23*t/T)+a24*sin(2*pi*24*t/T)+b24*cos(2*pi*24*t/T)    ...
                    +a25*sin(2*pi*25*t/T)+b25*cos(2*pi*25*t/T)+a26*sin(2*pi*26*t/T)    ...
                    +b26*cos(2*pi*26*t/T)+a27*sin(2*pi*27*t/T)+b27*cos(2*pi*27*t/T)    ...
                    +a28*sin(2*pi*28*t/T)+b28*cos(2*pi*28*t/T)+a29*sin(2*pi*29*t/T)    ...
                    +b29*cos(2*pi*29*t/T)+a30*sin(2*pi*30*t/T)+b30*cos(2*pi*30*t/T)    ...
                    +a31*sin(2*pi*31*t/T)+b31*cos(2*pi*31*t/T)+a32*sin(2*pi*32*t/T)    ...
                    +b32*cos(2*pi*32*t/T)+a33*sin(2*pi*33*t/T)+b33*cos(2*pi*33*t/T)    ...
                    +a34*sin(2*pi*34*t/T)+b34*cos(2*pi*34*t/T)+a35*sin(2*pi*35*t/T)    ...
                    +b35*cos(2*pi*35*t/T)+a36*sin(2*pi*36*t/T)+b36*cos(2*pi*36*t/T)    ...
                    +a37*sin(2*pi*37*t/T)+b37*cos(2*pi*37*t/T)+a38*sin(2*pi*38*t/T)    ...
                    +b38*cos(2*pi*38*t/T)+a39*sin(2*pi*39*t/T);
    end
end